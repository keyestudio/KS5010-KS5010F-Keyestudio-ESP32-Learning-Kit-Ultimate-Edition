...
1\.  Double click“thonny-4.1.7.exe”，the following dialog box will appear. I choose“![](media/11fb59a50abe0bf54df7e4cb891ad2c0.png)”to operate, you can also select“![](media/37be3f3bcc9aa0eb48c8b844eb46a71c.png)” to operate.
...
Download the driver of CP2102：[Download CP2102 Driver](CP2102-Driver-File-MAC.zip)
...
Firmware used in this tutorial is **esp32-20210902-v1.17.bin**，Webpage listing firmware of microPython for ESP32：[<span class="underline">https://micropython.org/download/esp32/</span>](https://micropython.org/download/esp32/)

![](media/c706d3cd6862323dcfccfd11ec7d1da3.png)

We also offer corresponding firmware. Please click the following link to download directly：[Python_Firmware](Python_Firmware.zip)
